    ...
    options: [
      {
        ...
        dropdownOptions: [
          ...
          { icon: "/assets/images/Slots.svg", text: "Slots", sidebarUrl: "/slots" },
          { icon: "/assets/images/Hat.svg", text: "Game Shows", sidebarUrl: "/game-shows" },
          {
          ...
          { icon: "/assets/images/Challenges.svg", text: "Challenges", sidebarUrl: "/challenges" },
          {
